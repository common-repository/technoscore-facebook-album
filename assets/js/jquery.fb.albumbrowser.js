...
(function ($) {
    $.fn.FacebookAlbumBrowser = function (options) {
        var defaults = {
            ...
            /* pluginImagesPath: "http://www.pixempire.com/images/preview/arrow-in-a-circle-point-to-left-icon.jpg", */
			pluginImagesPath:false,
            albumsPageSize: 0,
                                ...
                                if ($(result.data).get(a).count == null && settings.skipEmptyAlbums) {
                                    ...
                                    $(albumListItem).click(function () {
                                        ...
                                        previewContainer.append($("<img>", {
                                            ...
                                            height: 32,
                                            width: 32,
                                            src: settings.pluginImagesPath + "back.jpg",
                                            /* src: settings.pluginImagesPath, */
